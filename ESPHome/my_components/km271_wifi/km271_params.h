...
//    RITHK1    = 0x8005, //: "Raumisttemperatur HK1"           (Grad)
    ...
    MSHK1     = 0x6116, //: "Mischerstellung HK1"             (Prozent)  ECOMATIC4000
//    MSHK1     = 0x8009, //: "Mischerstellung HK1"             (Prozent)
    ...
    WWST      = 0x320c, //: "Warmwassersolltemperatur"        (Grad)  ECOMATIC4000
//    WWST      = 0x8426, //: "Warmwassersolltemperatur"        (Grad)
    WWIT      = 0x721A, //: "Warmwasseristtemperatur",        (Grad)  ECOMATIC4000
//    WWIT      = 0x8427, //: "Warmwasseristtemperatur",        (Grad)
    ...
    KVST      = 0x1206, //: "Kesselvorlaufsolltemperatur"     (Grad)  ECOMATIC4000
//    KVST      = 0x882a, //: "Kesselvorlaufsolltemperatur"     (Grad)
    KVIT      = 0x1105, //: "Kesselvorlaufisttemperatur"      (Grad)  ECOMATIC4000
